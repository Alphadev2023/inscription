  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Admin */}
        <Route element={<ProtectedRoute roles={[Role.ADMIN]}><MainLayout /></ProtectedRoute>}>
        ...
        {/* Agent */}
        <Route element={<ProtectedRoute roles={[Role.AGENT, Role.ADMIN]}><MainLayout /></ProtectedRoute>}>
          <Route path="/agent/dashboard" element={<AgentDashboard />} />
        </Route>

        {/* Candidat */}
        <Route element={<ProtectedRoute roles={[Role.CANDIDAT]}><MainLayout /></ProtectedRoute>}>
          <Route path="/candidat/dashboard"   element={<CandidatDashboard />} />
          <Route path="/candidat/inscription" element={<CandidatInscription />} />
