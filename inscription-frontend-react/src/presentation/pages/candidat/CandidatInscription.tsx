...
const DOCUMENTS_REQUIS = [
  {
    type: TypeDocument.DIPLOME_BAC,
    label: "Diplome du Baccalaureat",
    accept: ".pdf,.jpg,.jpeg,.png",
  },
  {
    type: TypeDocument.DIPLOME_SUPERIEUR,
    label: "Diplome Superieur",
    accept: ".pdf",
  },
  {
    type: TypeDocument.CNI_RECTO,
    label: "CNI Recto",
    accept: ".jpg,.jpeg,.png",
  },
  {
    type: TypeDocument.CNI_VERSO,
    label: "CNI Verso",
    accept: ".jpg,.jpeg,.png",
  },
  {
    type: TypeDocument.ACTE_NAISSANCE,
    label: "Acte de naissance",
    accept: ".pdf,.jpg,.jpeg,.png",
  },
  {
    type: TypeDocument.PHOTO_IDENTITE,
    label: "Photo identite",
    accept: ".jpg,.jpeg,.png",
  },
];
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-neutral-500 text-sm">
          Completez toutes les etapes pour soumettre votre dossier
        </p>
      </div>
          ...
          {ETAPES_LABELS.map(({ num, label, desc }, i) => (
            <div key={num} className="flex items-center flex-1">
              <div className="flex flex-col items-center">
                ...
                <p
                  className={`text-xs font-medium mt-1 ${etape === num ? "text-primary-600" : "text-neutral-400"}`}
                >
                  {label}
                </p>
              ...
              {i < ETAPES_LABELS.length - 1 && (
                <div
                  className={`flex-1 h-0.5 mx-2 mb-6 ${etape > num ? "bg-success-400" : "bg-neutral-200"}`}
                />
              )}
            </div>
          ))}
      ...
      <div className="bg-white rounded-xl border border-neutral-200 p-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  {...form1.register("nom")}
                  defaultValue={dossier?.candidat?.nom}
              ...
              <div>
                ...
                <input
                  ...
                  defaultValue={dossier?.candidat?.prenom}
                  className="w-full border border-neutral-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
                  placeholder="Jean"
                />
              ...
              <div>
                ...
                <input
                  {...form1.register("dateNaissance")}
                  type="date"
                  className="w-full border border-neutral-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
                />
                {form1.formState.errors.dateNaissance && (
                  <p className="text-danger-500 text-xs mt-1">
                    {form1.formState.errors.dateNaissance.message}
                  </p>
                )}
              </div>
              <div>
                ...
                <input
                  {...form1.register("nationalite")}
                  className="w-full border border-neutral-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
                  placeholder="Guineenne"
                />
                {form1.formState.errors.nationalite && (
                  <p className="text-danger-500 text-xs mt-1">
                    {form1.formState.errors.nationalite.message}
                  </p>
                )}
              </div>
              <div>
                ...
                <input
                  ...
                  defaultValue={dossier?.candidat?.telephone}
                  className="w-full border border-neutral-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
              ...
              <div>
                ...
                {form1.formState.errors.sexe && (
                  <p className="text-danger-500 text-xs mt-1">
                    {form1.formState.errors.sexe.message}
                  </p>
                )}
              </div>
              <div className="col-span-2">
                ...
                {form1.formState.errors.typePiece && (
                  <p className="text-danger-500 text-xs mt-1">
                    {form1.formState.errors.typePiece.message}
                  </p>
                )}
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {DOCUMENTS_REQUIS.map(({ type, label, accept }) => {
                const docExist =
                  dossier?.documents?.find((d) => d.type === type) ??
                  (uploadedTypes.has(type)
                    ? { nomFichierOriginal: "Document uploade" }
                    : null);
                return (
                  <div
                    key={type}
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  {...form3.register("dernierEtablissement")}
                  defaultValue={dossier?.dernierEtablissement}
                  className="w-full border border-neutral-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
                  placeholder="Universite de Conakry"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-neutral-700 mb-1">
                ...
                <input
                  {...form3.register("specialisation")}
                  defaultValue={dossier?.specialisation}
                  className="w-full border border-neutral-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
              ...
              <div>
                ...
                <input
                  {...form3.register("periodeFormation")}
                  defaultValue={dossier?.periodeFormation}
                  className="w-full border border-neutral-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
        ...
        {etape === 4 && (
          <div>
            ...
            <p className="text-neutral-500 text-sm">
              Vos coordonnees sont issues de votre compte.
            </p>
            <div className="mt-4 p-4 bg-neutral-50 rounded-lg">
              <p className="text-sm text-neutral-600">
                Email enregistre lors de la creation du compte.
              </p>
            </div>
          </div>
        )}
          ...
          <div>
              ...
              <div className="space-y-3 text-sm">
                <div className="p-4 bg-neutral-50 rounded-lg grid grid-cols-2 gap-3">
                  {[
                    ...
                    {
                      label: "Naissance",
                      value: dossier.candidat.dateNaissance,
                    },
                    {
                      label: "Nationalite",
                      value: dossier.candidat.nationalite,
                    },
                ...
                <div className="p-4 bg-neutral-50 rounded-lg">
                  <p className="text-neutral-400 text-xs mb-2">
                    Documents ({dossier.documents?.length ?? 0}/6)
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {dossier.documents?.map((doc) => (
                      <span
                        key={doc.id}
                        className="text-xs bg-success-100 text-success-600 px-2 py-1 rounded"
                      >
            ...
            <div className="mt-4 p-4 bg-primary-50 border border-primary-200 rounded-lg">
              <p className="text-primary-700 text-sm">
                En soumettant votre dossier, vous confirmez que toutes les
        ...
        <div className="flex items-center justify-between mt-6 pt-4 border-t border-neutral-100">
          ...
          {etape < 5 ? (
            <button
              onClick={() => {
                if (etape === 1) handleEtape1();
                else if (etape === 3) handleEtape3();
                else setEtape((e) => e + 1);
              }}
