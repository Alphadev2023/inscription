...
import { PaiementButton } from "@/presentation/components/paiement/PaiementButton";
import { FileText, CheckCircle, User } from "lucide-react";
import { StatutDossier, StatutValidation } from "@/domain/enums";

const FRAIS_INSCRIPTION = 25000; // TODO: remplacer par le vrai montant si dynamique
    ...
    return (
      <div className="text-center py-16">
        ...
        <p className="text-neutral-500">
          Aucun dossier trouvé. Commencez votre inscription.
        </p>
      </div>
    );
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-neutral-500 text-sm">
          Consultez et gérez votre dossier d&apos;inscription
        </p>
      </div>
        ...
        <div className="bg-success-50 border border-success-200 rounded-xl p-4">
          <div className="flex items-center gap-3">
            ...
            <p className="text-success-700 text-sm font-medium">
              Félicitations ! Votre dossier a été validé par notre équipe. Vous
              serez contacté prochainement.
            </p>
          </div>
          <div className="mt-4 pt-4 border-t border-success-200 flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-neutral-900">
                Frais d&apos;inscription
              </p>
              <p className="text-xs text-neutral-500">
                Reglez vos frais pour finaliser votre inscription
              </p>
            </div>
            <PaiementButton
