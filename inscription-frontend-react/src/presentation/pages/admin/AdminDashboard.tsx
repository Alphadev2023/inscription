    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-neutral-500 text-sm">
          Vue d&apos;ensemble de la plateforme d&apos;inscription
        </p>
      </div>
              ...
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="font-medium text-success-600">
                    {stats?.valides ?? 0}/{stats?.totalDossiers ?? 0}
                  </span>
                </div>
                ...
                <p className="text-right text-sm font-bold text-success-600 mt-1">
              ...
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="font-medium text-danger-600">
                    {stats?.rejetes ?? 0}/{stats?.totalDossiers ?? 0}
                  </span>
                </div>
                <div className="w-full bg-neutral-100 rounded-full h-2">
                  <div
                ...
                <p className="text-right text-sm font-bold text-danger-600 mt-1">
                  {tauxRejet.toFixed(0)}%
                </p>
              </div>
            </div>
