...
import com.inscription.inscription_backend.identity.infrastructure.recaptcha.RecaptchaService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> register(@Valid @RequestBody RegisterRequest request) {
        if (!recaptchaService.verifier(request.recaptchaToken())) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Captcha invalide, veuillez reessayer");
        }
